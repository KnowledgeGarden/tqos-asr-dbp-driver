...
public class DBpediaSpotlightClient  {
    ...
    private final String API_URL; // = "http://model.dbpedia-spotlight.org/en/"; //"http://spotlight.dbpedia.org/";
	private final double CONFIDENCE = 0.5;
	private final int SUPPORT = 0;

	public DBpediaSpotlightClient(DbpDriverEnvironment env) {
		environment = env;
		API_URL = environment.getStringProperty("SpotlightURL");
	}
